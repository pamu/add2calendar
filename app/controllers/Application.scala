...
object Application extends Controller {
  ...
  def insert(access_token: String) = Action.async {
    ...
    val data = Json.obj(
      ...
      "start" -> Json.obj("date" -> "2015-08-11", "dateTime" -> "2015-08-11T09:00:00-07:00", "timeZone" -> "Asia/Calcutta"),
      "end" -> Json.obj("date" -> "2015-08-11", "dateTime" -> "2015-08-11T17:00:00-07:00", "timeZone" -> "Asia/Calcutta"),
